package botanically_hexxy.utils
...
abstract class BotanicallyHexxyModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<BotanicallyHexxyModDependenciesExtension>("botanicallyhexxyModDependencies")
