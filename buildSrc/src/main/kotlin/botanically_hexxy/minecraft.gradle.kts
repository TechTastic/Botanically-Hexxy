...
package botanically_hexxy

import kotlin.io.path.div
import libs

plugins {
    id("botanically_hexxy.java")
...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/botanically_hexxy.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: botanically_hexxy-common-common-refmap.json
        // fixed:   botanically_hexxy-common.refmap.json
