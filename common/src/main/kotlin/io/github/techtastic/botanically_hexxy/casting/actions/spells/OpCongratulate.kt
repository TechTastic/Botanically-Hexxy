package io.github.techtastic.botanically_hexxy.casting.actions.spells
...
object OpCongratulate : SpellAction {
    ...
    private data class Spell(val target: Entity) : RenderedSpell {
        ...
        override fun cast(env: CastingEnvironment) {
            env.printMessage("text.botanically_hexxy.congrats".asTranslatedComponent(target.displayName));
        }
    }
}
