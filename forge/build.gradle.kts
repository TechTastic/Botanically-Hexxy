...
loom {
    forge {
        ...
        mixinConfig(
            "botanically_hexxy-common.mixins.json",
            "botanically_hexxy-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("botanically_hexxy.apply-datagen-mixin", "true")
                property("botanically_hexxy.$platform-datagen", "true")
            }
        }
    }
}

botanicallyhexxyModDependencies {
